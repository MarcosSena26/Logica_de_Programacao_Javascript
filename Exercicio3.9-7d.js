...
let horas = parseInt(prompt("Digite o tempo gasto no trajeto em horas: "))
let velocidade  = parseInt(prompt("Digite a velocidade no trajeto: "))

let distancia = horas * velocidade
let litrosUsados = distancia / 12

alert("O tempo gasto foi: "+horas+ "h")
alert("A velocidade média foi: "+velocidade+ "KM")
alert("A distância percorrida foi: "+distancia+ "KM")
alert("A quantidade de litros usados foi: "+litrosUsados+ "ml")
